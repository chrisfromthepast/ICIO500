...
place("D1", 154, 130, 0)     # Protection Diode
place("D2", 154, 140, 0)     # Protection Diode

# ==========================================================
# 2. BALANCED INPUT (Far Right Column: X=168-194, Y=58-155)
# Shifted left by 2mm to avoid courtyard crossing Edge.Cuts at 195
# ==========================================================
place("U2", 178, 105, 0)     # Input receiver
place("R1", 185, 100, 0)     
place("R2", 185, 110, 0)
place("C12", 181, 100, 0)    
place("C13", 181, 110, 0)
place("C14", 173, 105, 90)   
place("C9",  181, 105, 90)   
place("C10", 185, 92, 0)     
place("C11", 185, 118, 0)
place("D3", 173, 95, 0)
